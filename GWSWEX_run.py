...
gw_sw_interconnectivity = np.full(elems, vanG_pars[0], dtype=np.float64)
fwrite('gw_sw_interconnectivity.ip', np.array(gw_sw_interconnectivity, dtype=np.float64, order='F'))
